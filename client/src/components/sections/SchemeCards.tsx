...
export function SchemeCards() {
  return (
    <section className="bg-background py-16" id="schemes">
      <div className="container">
        <SectionHeading
          eyebrow="Schemes"
          title="Five Scholarships, One Application Journey"
          description="TS-One brings every Ministry of Tribal Affairs scholarship scheme onto a single unified portal."
        />
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {SCHEMES.map((scheme) => {
            const Icon = SCHEME_ICONS[scheme.key];
            return (
              <Card key={scheme.id} className="flex flex-col transition-shadow hover:shadow-gov-lg">
                <CardHeader>
